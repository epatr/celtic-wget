				...
				return this.each(function () {
						...
						var showMeanMenu = function() {
								...
								jQuery(removeElements).addClass('mean-remove');
									...
									jQuery('.mean-container').prepend('<div class="mean-bar"><a href="#nav" class="meanmenu-reveal '+options.meanRevealstyle+'" style="'+meanStyles+'">Show Navigation</a><nav class="mean-nav"></nav></div>');
